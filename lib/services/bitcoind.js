    ...
    this.client.getAddressTxids({addresses: addresses}, function(err, response) {
      ...
      async.mapSeries(
        ...
        function(err, transactions) {
          ...
          self.balanceCache.set(cacheKey, response);
...
Bitcoin.prototype._getAddressTxsFromMempool = function(addresses, callback) {
  var self = this;
  async.mapSeries(
    addresses,
 ...
 * @param {Function} callback
 */
Bitcoin.prototype.searchRawTransactions = function(address, callback) {
  var self = this;
  //TODO: CACHE
  self._tryAllClients(function(client, done) {
